...
public class Chat_Left_With_profile extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        IaImage = new chatapplication.swing.ImageAvatar();
        txt = new chatapplication.component.Chat_Item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/chatapplication/icon/testing/dog.jpg"))); // NOI18N
    ...
    private chatapplication.swing.ImageAvatar IaImage;
