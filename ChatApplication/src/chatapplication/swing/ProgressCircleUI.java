...
public class ProgressCircleUI extends BasicProgressBarUI {
   ...
   private final Progress pro;
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/chatapplication/icon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/chatapplication/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/chatapplication/icon/file.png")).getImage();
    }
    ...
    public void paint(Graphics g, JComponent c) {
        System.out.println("Painting progress circle");
